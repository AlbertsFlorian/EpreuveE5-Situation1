...
class InscriptionController extends AbstractController
{
    ...
    public function new(FormationRepository $formationRepository, InscriptionRepository $inscriptionRepository, $id): Response
    {
        ...
        //Récupère la formation choisie
        $formation = $this->getDoctrine()->getRepository(Formation::class)->find($id);
        //Récupère l'employé grâce à son id
        ...
        return $this->render('formation/employe.html.twig', [
            ...
            'inscriptions' => $inscriptionRepository->findByExampleField($employe),//renvoie les inscriptions selon l'id de l'employe
        ]);
    }
